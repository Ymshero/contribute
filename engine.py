...
def get_counts_and_averages(ID_and_ratings_tuple):
    ...
    sumlist = 0
    for x in ID_and_ratings_tuple[1]:
        sumlist += x
    return ID_and_ratings_tuple[0], (nratings, float(sumlist / nratings))
...
class RecommendationEngine:
    ...
    def __count_and_average_ratings(self):
        ...
        movie_ID_with_ratings_RDD.take(3)
        movie_ID_with_avg_ratings_RDD = movie_ID_with_ratings_RDD.map(get_counts_and_averages)
        self.movies_rating_counts_RDD = movie_ID_with_avg_ratings_RDD.map(lambda x: (int(x[0]), x[1][0]))
    ...
    #     pass
    #
    # def get_ratings_for_movie_ids(self, user_id, param):
    #     pass
    #
...
#
#
# RecommendationEngine.get_top_rating = get_top_ratings
